...
const ReviewStep: React.FC<ReviewStepProps> = ({
  ...
  const getSelectedObjectives = () => {
    ...
    if (formData.objectives.usabilityTesting) objectives.push('Trust and Credibility Assessment');
  ...
  const getSelectedMethods = () => {
    ...
    if (formData.testing.methods.focusgroups) methods.push('Focus Groups');
